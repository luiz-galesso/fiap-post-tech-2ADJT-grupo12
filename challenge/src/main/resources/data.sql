...
INSERT INTO TB_SOLICITACAO_VAGA
  ( ID, QUANTIDADE_DE_VAGAS, CARREIRA_ID, SOLICITANTE_CPF, DATA_SOLICITACAO, NIVEL, TITULO, DESCRICAO, SITUACAO, AVALIADOR_CPF, DATA_AVALIACAO, MENSAGEM) VALUES
  (NEXT VALUE FOR solicitacao_sequence, 3, 1, '98353850095','2023-01-25','JUNIOR', 'Programador','Programador com experiência em Java', 'ABERTA',null, null, null);
INSERT INTO TB_SOLICITACAO_VAGA
  ( ID, QUANTIDADE_DE_VAGAS, CARREIRA_ID, SOLICITANTE_CPF, DATA_SOLICITACAO, NIVEL, TITULO, DESCRICAO, SITUACAO, AVALIADOR_CPF, DATA_AVALIACAO, MENSAGEM) VALUES
  (NEXT VALUE FOR solicitacao_sequence, 5, 2, '49968313084','2023-02-19','PLENO', 'Product Owner','Product Owner para um sistema de gerenciamento de estoque', 'ABERTA',null, null, null);
INSERT INTO TB_SOLICITACAO_VAGA
   ( ID, QUANTIDADE_DE_VAGAS, CARREIRA_ID, SOLICITANTE_CPF, DATA_SOLICITACAO, NIVEL, TITULO, DESCRICAO, SITUACAO, AVALIADOR_CPF, DATA_AVALIACAO, MENSAGEM) VALUES
   (NEXT VALUE FOR solicitacao_sequence, 10, 3, '98353850095','2023-03-22','SENIOR', 'Gerente de Operação','Gerente para atuar na área de operações logísticas', 'ABERTA',null, null, null);
INSERT INTO TB_SOLICITACAO_VAGA
   ( ID, QUANTIDADE_DE_VAGAS, CARREIRA_ID, SOLICITANTE_CPF, DATA_SOLICITACAO, NIVEL, TITULO, DESCRICAO, SITUACAO, AVALIADOR_CPF, DATA_AVALIACAO, MENSAGEM) VALUES
   (NEXT VALUE FOR solicitacao_sequence, 1, 1, '49968313084','2023-04-11','JUNIOR', 'Programador','Programador com experiência em Python', 'APROVADA','47881175095', '2023-04-17', null);
INSERT INTO TB_SOLICITACAO_VAGA
  ( ID, QUANTIDADE_DE_VAGAS, CARREIRA_ID, SOLICITANTE_CPF, DATA_SOLICITACAO, NIVEL, TITULO, DESCRICAO, SITUACAO, AVALIADOR_CPF, DATA_AVALIACAO, MENSAGEM) VALUES
  (NEXT VALUE FOR solicitacao_sequence, 7, 2, '98353850095','2023-07-07','SENIOR', 'Product Owner','Product Owner para um sistema de ERP', 'REPROVADA','12179330006', '2023-07-07', 'Falta de verba');
