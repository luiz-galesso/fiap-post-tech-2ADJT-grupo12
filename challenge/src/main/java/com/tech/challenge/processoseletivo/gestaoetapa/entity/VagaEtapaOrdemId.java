...
public class VagaEtapaOrdemId implements Serializable {
    @Serial
    ...
    public VagaEtapaOrdemId() {
    }

    public VagaEtapaOrdemId(Candidato candidato, Vaga vaga, Etapa etapa) {
        this.candidato = candidato;
        this.vaga = vaga;
        this.etapa = etapa;
    }

    public VagaEtapaOrdemId(String idCandidato, Long idVaga, Long idEtapa) {
    ...
    public boolean equals(Object o) {
        ...
        VagaEtapaOrdemId that = (VagaEtapaOrdemId) o;
